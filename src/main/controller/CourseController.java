...
/**
 * calls createCourseOffering and adds a course offering to the courseCatalogue with an courseID, section number, and section cap.
 * @param args An object array that holds the course ID, section number, and section cap.
 * @throws InvalidRequestException This exception is thrown when createCourseOffering fails to create the course offering.
 */
	...
	/**
	 * calls removeCourseOffering from courseCatalogue and removes the course offering with the specified offeringId.
	 * @param offeringId The Id of the offering to be removed.
	 * @throws InvalidRequestException This exception is thrown when removeOffering fails to remove the course offering.
	 */
	...
	/**
	 * calls createCourse in courseCatalogue and creates a new course in the courseCatalogue with a given name and number.
	 * @param args An object array that contains the course name and course number.
	 * @throws InvalidRequestException This exception is thrown when createCourse fails to create the new course.
	 */
	...
	/**
	 * calls getCourse from the courseCatalogue and finds the desired course based on a given course name and course number.
	...
	/**
	 * calls getCourses from courseCatalogue and gets all of the courses in the courseCatalogue.
	...
	/**
	 * calls removeCourse from courseCatalogue and removes a course with the specified courseId.
	 * @param courseId The id of the target course.
	 * @throws InvalidRequestException This exception is thrown when removeCourse fails to remove the course.
	 */
	...
	/**
	 * calls getPreReqs from courseCatalogue and returns a list of the prerequisites of a course based on courseId.
	 * @param courseId The id of the target course
	...
	/**
	 * calls getOfferings from courseCatalogue and returns a list of the offerings based on courseId.
	 ...
	 * @throws InvalidRequestException Thrown when this function fails to add the specified prerequisite.
	 */
	 ...
	 * @param args object array containing parentCourseId and childCourseId.
	 * @throws InvalidRequestException Thrown when this function fails to remove the specified prerequisite.
	 */
