...
/**
 * A class that simulates a student holding an id, name and list of
 * registrations that the student may have.
 * 
...
public class Student implements Serializable {
	 ...
	 * @return returns true when the registration is added, returns false if the
	 ...
	 * @return returns true if the student is successfully removed from the course,
	 *         returns false if the student is not registered for the given course.
	 */
